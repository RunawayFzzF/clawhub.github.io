...
const PRECACHE_LIST = [
  ...
  "./js/jquery.min.js",
  "./js/bootstrap.min.js",
  "./js/clawhub-blog.min.js",
  "./js/snackbar.js",
  "./img/icon_wechat.png",
  "./img/avatar-clawhub.jpg",
  "./img/home-bg.jpg",
  "./img/404-bg.jpg",
  "./css/clawhub-blog.min.css",
  "./css/syntax.css",
...
// Tracking https://twitter.com/clawhub/status/798816417097224193
...
function sendMessageToClientsAsync(msg) {
  ...
  // https://twitter.com/clawhub/status/799265578443751424
